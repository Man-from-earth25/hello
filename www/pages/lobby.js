      ...
      <div className="navbar_right" id="navbar_right">
        <div className="web3">
          <li className="pnt_li navbar_list address_list blockchain_address_nav navbar_li pnt_li4">
            <img src="https://cdn.jsdelivr.net/gh/Man-from-earth25/battlebol/public/wallet/metamask.jpg" alt="e" className="blockchain_address_wallet" />
          ...
          <li className="pnt_li navbar_list balance_list blockchain_balance_nav navbar_li pnt_li4">
            <img src="https://cdn.jsdelivr.net/gh/Man-from-earth25/battlebol/public/blockchain/etherium.jpg" alt="e" className="blockchain_provider_name" />
