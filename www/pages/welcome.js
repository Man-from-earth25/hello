    ...
    <>
      <Head>
       ...
       <title>BattleBoll</title>
        ...
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/Man-from-earth25/battlebol/ui/welcome_page1o1.css"/>
      ...
      <nav className="WN">
        <ul className="WNU">
          <li className="WNUL">
            <div className="WNULC">
              <img src="https://cdn.jsdelivr.net/gh/Man-from-earth25/BattleBall/public/blockchain/avalanche.jpg" alt="e" className="logo" />
            ...
            <div className="intro">
              ...
              <div className="how_to_use">
                ...
                <div className="how_to_use_guide">
                  <img src="https://cdn.jsdelivr.net/gh/Man-from-earth25/BattleBall/public/Game.jpg" alt="img" className="how_to_use_guide_img" />
                </div>
              </div>
              <div className="how_to_use">
                <h2 className="how_to_use_text">Choose Your Ball By Buying Nfts!</h2>
                <div className="how_to_use_guide">
                  <img src="https://cdn.jsdelivr.net/gh/Man-from-earth25/BattleBall/public/Nft.jpg" alt="img" className="how_to_use_guide_img" />
                </div>
              </div>
              <div className="how_to_use">
                <h2 className="how_to_use_text">Play With Your Fellow Friends As A Team!</h2>
                <div className="how_to_use_guide">
                  <img src="https://cdn.jsdelivr.net/gh/Man-from-earth25/BattleBall/public/Team.jpg" alt="img" className="how_to_use_guide_img" />
                </div>
              </div>
              <div className="how_to_use">
                <h2 className="how_to_use_text">Start By Connecting Your Wallets And Setting Up Your Player Profile !</h2>
                <div className="how_to_use_guide">
                  <img src="https://cdn.jsdelivr.net/gh/Man-from-earth25/BattleBall/public/Connect.jpg" alt="img" className="how_to_use_guide_img" />
                </div>
              </div>
              <div className="how_to_use">
                <h2 className="how_to_use_text">Customize Your Gaming Experience With Your As You Like!</h2>
                <div className="how_to_use_guide">
                  <img src="https://cdn.jsdelivr.net/gh/Man-from-earth25/BattleBall/public/Customize.jpg" alt="img" className="how_to_use_guide_img" />
                </div>
              </div>
