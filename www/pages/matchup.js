              ...
              <div className="matchup_left_right_container ">
                <div className="matchup_nfts">
                  <div className="matchup_nfts_top">
                    <h1>Disco Bol</h1> </div>
                  <div className="matchup_nfts_center"> <img className="matchup_nfts_center_img" src="https://cdn.jsdelivr.net/gh/Man-from-earth25/battlebol/public/battlebol/disco.png" alt="e" /> </div>
