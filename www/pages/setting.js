  ...
  return (
    <>
        ...
        <Head>
           ...
           <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/Man-from-earth25/battlebol/ui/globals.css"/>
           <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/Man-from-earth25/battlebol/ui/component/thailand/thailand_ui_1o9.css"/>
           <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/Man-from-earth25/battlebol/ui/component/thailand/setting.css"/>
        ...
        <Script type="module" src="https://cdn.jsdelivr.net/gh/Man-from-earth25/battlebol/ux/globals.js" />
            ...
            <ul id="navbar_ul" className="navbar_ul">
              <div className="navbar_left" id="navbar_left">
                <div className="logo_container potla_poda_logo">
                  <img src="https://cdn.jsdelivr.net/gh/Man-from-earth25/battlebol/public/blockchain/avalanche.jpg" alt="e" className="logo" />
                ...
                <div className="settings_container">
                  ...
                  <div className="settings_container_right">
                    <div className="dropdown blockchain_dropdown network">
                      <div className="dropdown_select">
                        <img src="https://cdn.jsdelivr.net/gh/Man-from-earth25/battlebol/public/blockchain/etherium.jpg" alt="e" className="network_img network_dropdown_result" />
                      </div>
                      <div className="dropdown_menu">
                        <img src="https://cdn.jsdelivr.net/gh/Man-from-earth25/battlebol/public/blockchain/avalanche.jpg" alt="e" className="network_img" />
                        <img src="https://cdn.jsdelivr.net/gh/Man-from-earth25/battlebol/public/blockchain/bitcoin.jpg" alt="e" className="network_img" />
                        <img src="https://cdn.jsdelivr.net/gh/Man-from-earth25/battlebol/public/blockchain/polygon.jpg" alt="e" className="network_img" />
                        <img src="https://cdn.jsdelivr.net/gh/Man-from-earth25/battlebol/public/blockchain/solana.jpg" alt="e" className="network_img" />
                      </div>
                    </div>
