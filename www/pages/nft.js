      ...
      <nav id="navbar N" className="navbar ">
        <ul id="navbar_ul" className="navbar_ul">
          <div className="navbar_left" id="navbar_left">
            <div className="logo_container potla_poda_logo"> <img src="https://cdn.jsdelivr.net/gh/Man-from-earth25/battlebol/public/blockchain/avalanche.jpg" alt="e" className="logo" />
              ...
              <div className="player_name nft_container_small">
                <div className="nfts">
                  <div className="nfts_top">
                    ...
                    <div className="nfts_top_details"> <img src="https://cdn.jsdelivr.net/gh/Man-from-earth25/battlebol/public/battlebol/disco.png" alt="e" />
                ...
                <div className="nfts">
                  <div className="nfts_top">
                    ...
                    <div className="nfts_top_details"> <img src="https://cdn.jsdelivr.net/gh/Man-from-earth25/battlebol/public/battlebol/silver.png" alt="e" />
                      <div className="nfts_top_details_bottom">
                        <h1 className="nft_rararity">Rare</h1>
                        <h1 className="nft_level">Level9</h1> </div>
                    </div>
