            ...
            <div className="intro">
              ...
              <div className="how_to_use">
                ...
                <div className="how_to_use_guide">
                  <img src="https://cdn.jsdelivr.net/gh/Man-from-earth25/BattleBall/img/Game.jpg" alt="img" className="how_to_use_guide_img" />
                </div>
              </div>
              <div className="how_to_use">
                <h2 className="how_to_use_text">Choose Your Ball By Buying Nfts!</h2>
                <div className="how_to_use_guide">
                  <img src="https://cdn.jsdelivr.net/gh/Man-from-earth25/BattleBall/img/Nft.jpg" alt="img" className="how_to_use_guide_img" />
                </div>
              </div>
              <div className="how_to_use">
                <h2 className="how_to_use_text">Play With Your Fellow Friends As A Team!</h2>
                <div className="how_to_use_guide">
                  <img src="https://cdn.jsdelivr.net/gh/Man-from-earth25/BattleBall/img/Team.jpg" alt="img" className="how_to_use_guide_img" />
                </div>
              </div>
              <div className="how_to_use">
                <h2 className="how_to_use_text">Start By Connecting Your Wallets And Setting Up Your Player Profile !</h2>
                <div className="how_to_use_guide">
                  <img src="https://cdn.jsdelivr.net/gh/Man-from-earth25/BattleBall/img/Connect.jpg" alt="img" className="how_to_use_guide_img" />
                </div>
              </div>
              <div className="how_to_use">
                <h2 className="how_to_use_text">Customize Your Gaming Experience With Your As You Like!</h2>
                <div className="how_to_use_guide">
                  <img src="https://cdn.jsdelivr.net/gh/Man-from-earth25/BattleBall/img/Customize.jpg" alt="img" className="how_to_use_guide_img" />
                </div>
              </div>
