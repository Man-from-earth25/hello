    ...
    <ul id="navbar_ul" className="navbar_ul">
      <div className="navbar_left" id="navbar_left">
        ...
        {/* <div class="logo_container">
                  <img src="./public/blockchain/avalanche.jpg" alt="e" class="logo">
      ...
      <div className="navbar_right" id="navbar_right">
        <div className="web3">
          <li className="pnt_li navbar_list address_list blockchain_address_nav navbar_li pnt_li4">
            <img src="./public/wallet/metamask.jpg" alt="e" className="blockchain_address_wallet" />
          ...
          <li className="pnt_li navbar_list balance_list blockchain_balance_nav navbar_li pnt_li4">
            <img src="./public/blockchain/etherium.jpg" alt="e" className="blockchain_provider_name" />
      ...
      <div className="navbar_profile_container_guard_default NDPCGD ">
        <div className="NDPCGDT">
          ...
          <div className="NDPCGDTC">
            <img src="./public/blockchain/etherium.jpg" alt="e" className="NDPCGDTCL" />
  ...
  <nav className="navbar_scan_container NDAC">
    <ul className="navbar_scan_container_ul NDACU">
      <li className="navbar_scan_container_ul_li NDACUL">
        ...
        <img src="./public/blockchain/solana.jpg" alt="e" className="navbar_scan_container_ul_li_img NDACULI" />
      </li>
    </ul>
  </nav>
  {/* ////////////////////// Drop downs Start ////////////////// */}
