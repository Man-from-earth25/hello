                ...
                <div className="settings_container">
                  ...
                  <div className="settings_container_right">
                    <div className="dropdown blockchain_dropdown network">
                      <div className="dropdown_select">
                        <img src="./public/blockchain/etherium.jpg" alt="e" className="network_img network_dropdown_result" />
                      </div>
                      <div className="dropdown_menu">
                        <img src="./public/blockchain/avalanche.jpg" alt="e" className="network_img" />
                        <img src="./public/blockchain/bitcoin.jpg" alt="e" className="network_img" />
                        <img src="./public/blockchain/polygon.jpg" alt="e" className="network_img" />
                        <img src="./public/blockchain/solana.jpg" alt="e" className="network_img" />
                      </div>
                    </div>
