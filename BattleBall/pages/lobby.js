...
export default function Home() {
  return (
    ...
    <div className="mobile_landscaper">
      ...
      <h1>Please Turn Your Phone To Landscape Mode For Good Experience!!!</h1>
    </div>
    ...
    <ul id="navbar_ul" className="navbar_ul">
      <div className="navbar_left" id="navbar_left">
        ...
        {/* <div class="logo_container">
                  <img src="https://cdn.jsdelivr.net/gh/Man-from-earth25/BattleBall/img/blockchain/avalanche.jpg" alt="e" class="logo">
      ...
      <div className="navbar_center" id="navbar_center">
        <div className="logo_container">
          <img src="https://cdn.jsdelivr.net/gh/Man-from-earth25/BattleBall/img/blockchain/avalanche.jpg" alt="e" className="logo" />
      ...
      <div className="navbar_right" id="navbar_right">
        <div className="web3">
          <li className="pnt_li navbar_list address_list blockchain_address_nav navbar_li pnt_li4">
            <img src="https://cdn.jsdelivr.net/gh/Man-from-earth25/BattleBall/img/wallet/metamask.jpg" alt="e" className="blockchain_address_wallet" />
          ...
          <li className="pnt_li navbar_list balance_list blockchain_balance_nav navbar_li pnt_li4">
            <img src="https://cdn.jsdelivr.net/gh/Man-from-earth25/BattleBall/img/blockchain/etherium.jpg" alt="e" className="blockchain_provider_name" />
  ...
  {/* Sidebar */}
  <nav id="sidebar S" className="sidebar close shadow-sm ">
    <ul id="sidebar_ul" className="SU sidebar_ul">
      <div className="SULC">
        <li className="sidebar_ul_li SUL hover:shadow-2xl" id="sidebar_ul_li1">
          <link passhref href="/home" />
          <ion-icon name="home" />
          <a href="#">Home</a>
        </li>
        <link passhref href="/exchange" />
        <li className="sidebar_ul_li SUL SUL hover:shadow-2xl" id="sidebar_ul_li2">
          <ion-icon name="cash" />
          <a href="#">Exchange</a>                               
        </li>
        <li className="sidebar_ul_li SUL SUL hover:shadow-2xl" id="sidebar_ul_li2">
        ...
        <li className="sidebar_ul_li SUL hover:shadow-2xl" id="sidebar_ul_li2">
        ...
        <li className="sidebar_ul_li SUL hover:shadow-2xl" id="sidebar_ul_li3">
          <link passhref href="/ido_event" />
          <ion-icon name="medal" />
          <a href="#">Ido-Event</a>
        </li>
        <li className="sidebar_ul_li SUL hover:shadow-2xl" id="sidebar_ul_li4">
          <ion-icon name="ribbon" />
          <a href="#">Ido</a>
        </li>
        <li className="sidebar_ul_li SUL hover:shadow-2xl" id="sidebar_ul_li5">
          <link passhref href="/gamefi" />
          <ion-icon name="game-controller" />
          <a href="#">GameFi</a>
        </li>
        <li className="sidebar_ul_li SUL hover:shadow-2xl" id="sidebar_ul_li7">
          <link passhref href="/support_ukrane" />
          <ion-icon name="sparkles" />
          <a href="#">Support Ukraine</a>
        </li>
      </div>
      <div className="sidebar_ul_line">
        <li className="st st1">
          <div className="st_main" id="st_m1">
            <ion-icon name="list" />
            <a href="#">More</a>
            <ion-icon name="chevron-forward" />
          </div>
          <div className="st_toggle">
            <a href="#">Twitter</a>
            <a href="#">Discord</a>
            <a href="#">Facebook</a>
            <a href="#">Telegram</a>
        ...
        <li className="st st2">
          <div className="st_main" id="st_m2">
            <ion-icon name="heart" />
            <a href="#">Favorite</a>
            <ion-icon name="chevron-forward" />
          </div>
        ...
        <li className="st st3">
          <div className="st_main" id="st_m3">
            <ion-icon name="book" />
            <a href="#">Docs</a>
            <ion-icon name="chevron-forward" />
          </div>
        ...
        <li className="st st4">
          <div className="st_main" id="st_m4">
        ...
        <li className="st st5">
          <div className="st_main" id="st_m5">
        ...
        <li className="st st6">
          <div className="st_main" id="st_m6">
      ...
      <div className="navbar_profile_container_guard_default NDPCGD ">
        <div className="NDPCGDT">
          ...
          <div className="NDPCGDTC">
            <img src="https://cdn.jsdelivr.net/gh/Man-from-earth25/BattleBall/img/blockchain/etherium.jpg" alt="e" className="NDPCGDTCL" />
  ...
  <nav className="navbar_scan_container NDAC">
    <ul className="navbar_scan_container_ul NDACU">
      <li className="navbar_scan_container_ul_li NDACUL">
        ...
        <img src="https://cdn.jsdelivr.net/gh/Man-from-earth25/BattleBall/img/blockchain/solana.jpg" alt="e" className="navbar_scan_container_ul_li_img NDACULI" />
      </li>
    </ul>
  </nav>
  {/* ////////////////////// Drop downs Start ////////////////// */}
  ...
  <main className="M">
    {/* Hero Start */}
    <div id="main_container" className="space-y-0.5">
